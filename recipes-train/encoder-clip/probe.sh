...
#
# Usage:
#   ./recipes-train/encoder-clip/probe.sh checkpoints/encoder-clip/checkpoint-4200/checkpoint.pt
#   ./recipes-train/encoder-clip/probe.sh checkpoints/encoder-clip/checkpoint-4200/checkpoint.pt --n-positions 2000
...
uv run python recipes-train/encoder-clip/probe_checkpoint.py \
